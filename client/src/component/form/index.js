...
export default function Form() {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const placeInput = thePlace.place;
        const latitude = thePlace.latLng.lat;
        const longitude = thePlace.latLng.lng;
        ...
        setPost({ title: titleInput, textBody: postInput, tags: tagsInput, titleImageLink: titleImageLink, bodyImageLinks: linksArray, postVid: postVidLink, userId: userId, place: placeInput, lat: latitude, lng: longitude })
        try {
